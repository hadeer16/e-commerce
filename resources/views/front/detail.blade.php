          ...
          <div class="row mb-5">
            <div class="col-lg-6">
              ...
              <div class="row m-sm-0">
                <div class="col-8 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                  <div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="{{ asset('product_img/'.$data->image) }}" alt="..."></div>
                  </div>
                </div>
            ...
            <div class="col-lg-6">
              ...
              <ul class="list-unstyled small d-inline-block">
                ...
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Category:</strong><a class="reset-anchor ml-2" href="#">{{ $data->cate->name }}</a></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="product text-center skel-loader">
                <div class="d-block mb-3 position-relative"><a class="d-block" href="{{ route('detail.show',$proda->id) }}"><img style="width:200px; height:200px" class="img-fluid w-100" src="{{ asset('product_img/'.$proda->image) }}" alt="..."></a>
                ...
                <h6> <a class="reset-anchor" href="{{ route('detail.show',$proda->id) }}">{{ $proda->name }}</a></h6>
                <p class="small text-muted">{{ $proda->price }}$</p>
              </div>
            </div>
            @endforeach
            <!-- PRODUCT-->
