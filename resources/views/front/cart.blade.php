                  ...
                  @foreach($data as $cart)
                    <tr>
                      <th class="pl-0 border-0" scope="row">
                        <div class="media align-items-center"><a class="reset-anchor d-block animsition-link" href="{{ route('detail.show',$cart->products->id) }}"><img src="{{asset('product_img/'.$cart->products->image)}}" alt="..." width="70"/></a>
                          <div class="media-body ml-3"><strong class="h6"><a class="reset-anchor animsition-link" href="{{ route('detail.show',$cart->products->id) }}">{{$cart->products->name}}</a></strong></div>
                        </div>
                      </th>
                      ...
                      <td class="align-middle border-0">
                        <p class="mb-0 small">{{$cart->quantity}}</p>
                      </td>
                      <td class="align-middle border-0">
