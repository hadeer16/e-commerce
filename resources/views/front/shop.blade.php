                  ...
                  <div class="col-lg-4 col-sm-6">
                      <div class="product text-center">
                        <div class="mb-3 position-relative">
                          <div class="badge text-white badge-" style="width:300px; height:300px"></div><a class="d-block" href="{{ route('detail.show',$products->id) }}"><img style="width:200px; height:150px" class="img-fluid w-100" src="{{ asset('product_img/'.$products->image) }}" alt="..."></a>
